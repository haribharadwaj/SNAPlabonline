    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(help_text='Enter your age in years', null=True, validators=[users.models.adults_only])),
                ...
                ('hl_dur', models.PositiveSmallIntegerField(help_text='Number of years since you were first given a hearing-loss diagnosis', null=True, verbose_name='How long have you had hearing loss?')),
                ('hl_degree', models.CharField(choices=[('MI', 'Mild Hearing Loss'), ('MO', 'Moderate Hearing Loss'), ('SE', 'Severe Hearing Loss'), ('SP', 'Severe-to-Profound Hearing Loss'), ('PR', 'Profound Hearing Loss'), ('UN', 'I Do Not Know'), ('O', 'Other')], default='UN', help_text='If you happen to know you what degree you were diagnosed with, please enter here', max_length=2, verbose_name='Degree of hearing loss')),
                ('hl_write_in', models.CharField(help_text='If you selected "Other" for degree of hearing loss', max_length=256, null=True, verbose_name='Please write in')),
                ('hl_subjective', models.CharField(choices=[('G', 'Is as good is better than or similar to others my age'), ('Y', 'I have some trouble when there is background noise (e.g., at restaurants, busy streets)'), ('R', 'I have more trouble than others my age in most situations')], help_text='How do you think your hearing compares to other people your age?', max_length=1, null=True, verbose_name='Hearing Ability')),
