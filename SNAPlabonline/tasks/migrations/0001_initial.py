    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_url', models.CharField(default=tasks.models.create_task_slug, max_length=32, unique=True)),
                ('date_created', models.DateTimeField(default=django.utils.timezone.now)),
                ('experimenter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='serverside_task_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Response',
